	...
	$('.add-statement').click(function(){
		...
		section_container
			.find('.add-statement-form-container')
				.show()
				.find('.new-statement-text-editor')
					.focus().select();
		$.ajax({url: '/inspector_statements',
				method: 'get',
		...
		.done(function(response){
			...
			if (response.length > 0) {
				$.each(response,function(index, statement){
					statement_library_container.append('<li><span class="statement-type" data-statement-type-id="'+ statement.statement_type_id +'">'+ statement.statement_type.name +'</span>: ('+ statement.keyword +') <span class="statement-content">'+ statement.content +'</span></li>');
				});
				statement_library_container.children('li').click(function(){
				...
				statement_library_container.append('<li>You have no statements saved for this section.</li>');
			}
		})
		.fail(function(){
